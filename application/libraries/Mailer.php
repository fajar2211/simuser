...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'notifikasi.simpus2@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Notifikasi Simpus'; // Isikan dengan nama pengirim
    protected $password = 'DinkesYK'; // Isikan dengan password email pengirim
